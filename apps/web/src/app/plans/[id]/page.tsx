        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden bg-white group">
              ...
              <CardFooter className="px-6 pb-6">
                <Button className="w-full bg-blue-600 hover:bg-indigo-700  text-white py-6 rounded-xl shadow-md hover:shadow-xl transition-all font-semibold text-lg">
                  Select Plan
                </Button>
              </CardFooter>
            </Card>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden bg-white group flex flex-col justify-between">
              ...
              <CardFooter className="px-6 pb-6">
                <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-6 rounded-xl shadow-md hover:shadow-xl transition-all font-semibold text-lg">
                  Select Plan
                </Button>
              </CardFooter>
            </Card>
